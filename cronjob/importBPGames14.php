...
foreach ($arContainerGame as $arGame) {
	if ($arGame[1] == "Datum") {
		...
		$arRowConf['locationId'] = array_search('locationId', $arGame );
		$arRowConf['location'] = array_search('Halle', $arGame );
		$arRowConf['homeId'] = array_search('homeId', $arGame );
		$arRowConf['home'] = array_search('Heimmannschaft', $arGame );
		$arRowConf['awayId'] = array_search('awayId', $arGame );
